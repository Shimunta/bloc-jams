...
var setSong = function(sn) {
    if (currentSoundFile) {
        currentSoundFile.stop();
    }
    
    currentlyPlayingSongNumber = sn;
    currentSongFromAlbum = currentAlbum.songs[sn - 1];
...
var getSongNumberCell = function(n) {
    return $('.song-item-number[data-song-number="' + n + '"]')
}
